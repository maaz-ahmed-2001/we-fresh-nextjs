...
const index = () => {
  ...
  return (
    ...
    <SectionWrapper className="flex items-center !pt-14 sm:!pt-20 lg:!pt-28 justify-center overflow-hidden">
      ...
      <SvgWrapper src="/HeroSectionPng/SmallScreenBlueImage.png" className="block small-mobile:hidden h-[45vh]  w-full top-[-6%] absolute  -z-10" />
      {/* THE LEFT BLUE ONE */}
      <SvgWrapper
        src="/HeroSectionPng/LeftBlueImage.svg"
        className="absolute lg:rotate-0 hidden small-mobile:block rotate-90 scale-[2.2] sm:scale-[2] lg:scale-100 top-[-18%] sm:top-[-50%] md:top-[-40%] lg:top-[0%] left-[-15%] sm:left-[-17%] md:left-[-16%] lg:left-[-22%] xl:left-[-10%] 2xl:left-[0%] -z-10 h-[40vh] sm:h-full w-full max-h-[397px] sm:max-h-[689px] xl:max-h-[889px] xl:max-w-[1139px]"
      />
      {/* LIGHT BLUE SVG */}
      <SvgWrapper
        src="/HeroSectionPng/LightBlueImage.svg"
        className="w-full h-full max-w-[557px] xl:max-w-[657px] max-h-[392px] xl:max-h-[492px] absolute -z-20 left-[-15%] small-mobile:left-[-20%] sm:left-[-4%] md:left-[8%] lg:left-[3%] xl:left-[8%] 2xl:left-[15%] top-[25%] small-mobile:top-[23%] sm:top-[15%] md:top-[25%] lg:top-[40%] xl:top-[30%] 2xl:top-[33%]"
      />
      ...
      <FlexCenter className="gap-[10rem] lg:gap-7 w-full flex-col lg:flex-row !justify-center lg:!justify-around">
        {/* LEFT SIDE FORM DIV */}
